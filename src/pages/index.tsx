	...
	return (
		<Layout pageName="home" pageTitle="F0lio - Home">
			<div className="px-2 selection:text-primary-2">
				<div className="group flex cursor-pointer items-end font-mono text-4xl text-gray-100 sm:text-5xl">
					<div className="items-start sm:flex sm:grid-cols-2">
						...
						<div className="col-span-2 flex items-end whitespace-nowrap ">
							...
							<p className="px-3 text-lg text-gray-400 group-hover:text-primary-3 sm:text-xl ">
								(aka F0lio)
							</p>
						</div>
					</div>
